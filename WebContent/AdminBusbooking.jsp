...
<div class="section">
<img id="img1" class="st" src="http://www.greenlinetravelsmysore.com/images/2.jpg" style="display: none;">
    <img id="img2" class="st" src="http://wallpapers55.com/wp-content/uploads/2013/10/Bus-In-Town-Photos.jpg" style="display: none;">
    <img id="img3" class="st" src="http://amazingwallpapers.net/walls/electric-double-decker-bus-london-HD.jpg" style="display: none;">
    <img id="img4" class="st" src="http://previews.123rf.com/images/welcomia/welcomia1407/welcomia140700111/29601758-White-Tour-Bus-Isolated-on-Solid-White-Background-Bus-Illustration--Stock-Illustration.jpg" style="display: none;">
    <img id="img5" class="st" src="http://img0.gtsstatic.com/wallpapers/6c7b1dc93ee8d4e1ec9e5d6cf4dfb0a5_large.jpeg" style="display: none;">
     <img id="img6" class="st" src="http://1.bp.blogspot.com/-FrDy7s3rj84/VW3Ep-wmS6I/AAAAAAAA46E/wbym8bn6U-U/s1600/DSC_5830.jpg" style="display: none;">

<a href="AddBus.jsp" style="color:white;text-decoration:none;align:center;"><button class="button button1"><b>ADD BUS</b></button></a>
 <a href="DeleteBus.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>DELETE BUS</b></button></a>
 <a href="UpdateBus1.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>UPDATE BUS</b></button></a>
  <a href="Adminviewallbus.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>VIEW ALL BUS</b></button></a>
</div>
