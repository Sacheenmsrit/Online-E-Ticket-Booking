...
<div class="section">
<img id="img1" class="st" src="https://d152j5tfobgaot.cloudfront.net/wp-content/uploads/2016/02/yourstory-west-bengal-taxi.jpg" style="display: none;">
    <img id="img2" class="st" src="http://images.financialexpress.com/2015/09/ola-cabs-l.jpg" style="display: none;">
    <img id="img3" class="st" src="https://pixabay.com/static/uploads/photo/2016/06/04/21/06/carsharing-1436203_960_720.jpg" style="display: none;">
    <img id="img4" class="st" src="http://vistanews.ru/uploads/posts/2016-05/1463534848_1.jpg" style="display: none;">
    <img id="img5" class="st" src="http://www.hdcarwallpapers.com/walls/2016_bugatti_chiron_3-HD.jpg" style="display: none;">
     <img id="img6" class="st" src="https://i.ytimg.com/vi/gdtC3eyKyPk/hqdefault.jpg" style="display: none;">
<a href="common.jsp" style="color:white;text-decoration:none;align:center;"><button class="button button1"><b>ADD CAB</b></button></a>
 <a href="common.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>DELETE CAB</b></button></a>
 <a href="common.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>UPDATE CAB</b></button></a>
  <a href="common.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>VIEW ALL CAB</b></button></a>
</div>
