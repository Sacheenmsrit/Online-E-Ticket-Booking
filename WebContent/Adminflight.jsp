...
<div class="section">
<img id="img1" class="st" src="http://www.hdwallpapersnews.com/wp-content/uploads/2015/04/Flight_Takeoff-Full-HD-Wallpapers-1080p.jpg" style="display: none;">
    <img id="img2" class="st" src="https://i.ytimg.com/vi/W-SVPekql5Q/maxresdefault.jpg" style="display: none;">
    <img id="img3" class="st" src="https://i.ytimg.com/vi/6NHrny0CBiU/maxresdefault.jpg" style="display: none;">
    <img id="img4" class="st" src="http://1.bp.blogspot.com/-7xyNR5682Ow/UzrBWADR8wI/AAAAAAAACyc/t2ecC5u6g2U/s1600/1080p+Hd+Aeropane+Images.jpg" style="display: none;">
    <img id="img5" class="st" src="https://wallpaperscraft.com/image/airplane_flight_sky_smoke_beautifully_11237_1920x1080.jpgs" style="display: none;">
     <img id="img6" class="st" src="https://i.ytimg.com/vi/szdW22mqNBQ/maxresdefault.jpg" style="display: none;">
<a href="common.jsp" style="color:white;text-decoration:none;align:center;"><button class="button button1"><b>ADD FLIGHT</b></button></a>
 <a href="common.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>DELETE FLIGHT</b></button></a>
 <a href="common.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>UPDATE FLIGHT</b></button></a>
  <a href="common.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>VIEW ALL FLIGHT</b></button></a>
</div>
</div>>
