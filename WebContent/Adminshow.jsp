...
<div class="section">
<a href="common.jsp" style="color:white;text-decoration:none;align:center;"><button class="button button1"><b>ADD SHOW</b></button></a>
 <a href="common.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>DELETE SHOW</b></button></a>
 <a href="common.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>UPDATE SHOW</b></button></a>
  <a href="common.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>VIEW ALL SHOW</b></button></a>
</div>
