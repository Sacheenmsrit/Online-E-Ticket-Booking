...
<div class="section">
<a href="common.jsp" style="color:white;text-decoration:none;align:center;"><button class="button button1"><b>ADD TRAIN</b></button></a>
 <a href="common.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>DELETE TRAIN</b></button></a>
 <a href="common.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>UPDATE TRAIN</b></button></a>
  <a href="common.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>VIEW ALL TRAIN</b></button></a>
</div>
