...
<ul class="pagination1">
  <li><a href="Main.jsp" class="active" checked>Home</a></li>
  <li><a href="photogalary.jsp">Photo Gallary</a></li>
  <li><a href="aboutus.jsp">About us</a></li><li><a href="Main.jsp" class="active" checked>Home</a></li>
  <li><a href="photogalary.jsp">Photo Gallary</a></li>
	<li><a href="contactus.jsp" class="active" checked>Contact Us</a></li>
...
<div>
  <form action="datacapture.jsp" method="post">
    <label for="fname">From &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</label>
    <input type="text" id="fname" name="from">
	...
	<br><label for="dob">Date of Jurney:</label>
    <input type="text" id="dob" name="doj">
	<label for="dob">Date of Return:</label>
    <input type="text" id="dob" name="dor">
