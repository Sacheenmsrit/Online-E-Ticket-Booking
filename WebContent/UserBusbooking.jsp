...
<a href="userBusbook1.jsp" style="color:white;text-decoration:none;align:center;"><button class="button button1"><b>SEARCH AND BOOK</b></button></a>
 ...
 <a href="common.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>CANCEL RESERVATION</b></button></a>
  <a href="Userveiwallbus.jsp" style="color:white;text-decoration:none;"><button class="button button2"><b>VIEW ALL BUS</b></button></a>
</div>
