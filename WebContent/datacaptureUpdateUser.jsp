...
<%
	...
	PreparedStatement ps=conn.prepareStatement("UPDATE `UserDetails` SET  FirstName=?,LastName=?,DOB=?,Sex=?,Nationality=?,MobileNo=?,EmailId=?,UserName=?,Password=? where Hint =?"); 
